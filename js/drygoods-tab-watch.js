/* ================================================================
   ...
   Untuk memastikan tab Data Stok / Dashboard Drygoods / Bank Item
...
!function () {
  ...
  function bindSidebarShortcuts() {
    document.querySelectorAll('[data-tab="drygoods-data"],[data-tab="drygoods-dashboard"],[data-tab="drygoods-bankitem"]').forEach(function (btn) {
  ...
  var WATCH_TABS = ["drygoods-data", "drygoods-dashboard", "drygoods-bankitem"];
